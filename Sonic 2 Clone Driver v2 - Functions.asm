...
; sub_135E: PlayMusic:
SMPS_QueueSound1:
	tst.b	(Clone_Driver_RAM+SMPS_RAM.v_variables.v_playsnd1).w
	bne.s	+
	move.b	d0,(Clone_Driver_RAM+SMPS_RAM.v_variables.v_playsnd1).w
	rts
+
	move.b	d0,(Clone_Driver_RAM+SMPS_RAM.v_variables.v_playsnd4).w
	rts
...
; sub_1370: PlaySound:
SMPS_QueueSound2:
	move.b	d0,(Clone_Driver_RAM+SMPS_RAM.v_variables.v_playsnd2).w
+	rts
...
SMPS_QueueSound3:
	move.b	d0,(Clone_Driver_RAM+SMPS_RAM.v_variables.v_playsnd3).w
	rts
