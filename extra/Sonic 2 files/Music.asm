...
; Music data
; ---------------------------------------------------------------------------
Music81:	include		"music/81 - 2 Player Menu.asm"
		even
Music82:	include		"music/82 - EHZ.asm"
		even
Music83:	include		"music/83 - MCZ 2P.asm"
		even
Music84:	include		"music/84 - OOZ.asm"
		even
Music85:	include		"music/85 - MTZ.asm"
		even
Music86:	include		"music/86 - HTZ.asm"
		even
Music87:	include		"music/87 - ARZ.asm"
		even
Music88:	include		"music/88 - CNZ 2P.asm"
		even
Music89:	include		"music/89 - CNZ.asm"
		even
Music8A:	include		"music/8A - DEZ.asm"
		even
Music8B:	include		"music/8B - MCZ.asm"
		even
Music8C:	include		"music/8C - EHZ 2P.asm"
		even
Music8D:	include		"music/8D - SCZ.asm"
		even
Music8E:	include		"music/8E - CPZ.asm"
		even
Music8F:	include		"music/8F - WFZ.asm"
		even
Music90:	include		"music/90 - HPZ.asm"
		even
Music91:	include		"music/91 - Options.asm"
		even
Music92:	include		"music/92 - Special Stage.asm"
		even
Music93:	include		"music/93 - Boss.asm"
		even
Music94:	include		"music/94 - Final Boss.asm"
		even
Music95:	include		"music/95 - SWEET SWEET SWEET.asm"
		even
Music96:	include		"music/96 - Super Sonic.asm"
		even
Music97:	include		"music/97 - Invincible.asm"
		even
Music98:	include		"music/98 - Extra Life.asm"
		even
Music99:	include		"music/99 - Title Screen.asm"
		even
Music9A:	include		"music/9A - End of Act.asm"
		even
Music9B:	include		"music/9B - Game Over.asm"
		even
Music9C:	include		"music/9C - Continue.asm"
		even
Music9D:	include		"music/9D - Got Emerald.asm"
		even
Music9E:	include		"music/9E - Credits.asm"
		even
Music9F:	include		"music/9F - Drowning.asm"
		even
