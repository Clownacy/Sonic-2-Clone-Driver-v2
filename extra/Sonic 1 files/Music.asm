...
Music81:	include		"music/Mus81 - GHZ.asm"
		even
Music82:	include		"music/Mus82 - LZ.asm"
		even
Music83:	include		"music/Mus83 - MZ.asm"
		even
Music84:	include		"music/Mus84 - SLZ.asm"
		even
Music85:	include		"music/Mus85 - SYZ.asm"
		even
Music86:	include		"music/Mus86 - SBZ.asm"
		even
Music87:	include		"music/Mus87 - Invincibility.asm"
		even
Music88:	include		"music/Mus88 - Extra Life.asm"
		even
Music89:	include		"music/Mus89 - Special Stage.asm"
		even
Music8A:	include		"music/Mus8A - Title Screen.asm"
		even
Music8B:	include		"music/Mus8B - Ending.asm"
		even
Music8C:	include		"music/Mus8C - Boss.asm"
		even
Music8D:	include		"music/Mus8D - FZ.asm"
		even
Music8E:	include		"music/Mus8E - Sonic Got Through.asm"
		even
Music8F:	include		"music/Mus8F - Game Over.asm"
		even
Music90:	include		"music/Mus90 - Continue Screen.asm"
		even
Music91:	include		"music/Mus91 - Credits.asm"
		even
Music92:	include		"music/Mus92 - Drowning.asm"
		even
Music93:	include		"music/Mus93 - Get Emerald.asm"
		even
