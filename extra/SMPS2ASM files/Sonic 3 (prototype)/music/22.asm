s3p22_Header:
	...
	smpsHeaderVoice     s3p22_Voices
	smpsHeaderChan      $06, $03
	smpsHeaderTempo     $01, $08

	smpsHeaderDAC       s3p22_DAC
	smpsHeaderFM        s3p22_FM1,	$00, $0F
	smpsHeaderFM        s3p22_FM2,	$00, $0B
	smpsHeaderFM        s3p22_FM3,	$00, $0C
	smpsHeaderFM        s3p22_FM4,	$00, $0F
	smpsHeaderFM        s3p22_FM5,	$00, $18
	smpsHeaderPSG       s3p22_PSG1,	$E8, $02, $00, $00
	smpsHeaderPSG       s3p22_PSG2,	$E8, $02, $00, $00
	smpsHeaderPSG       s3p22_PSG3,	$E8, $02, $00, $00
...
s3p22_Loop13:
	...
	smpsLoop            $00, $02, s3p22_Loop13
	smpsSetvoice        $03

s3p22_Loop14:
	dc.b	nAb3, $06, nBb3, nC4, nEb4
	smpsLoop            $00, $04, s3p22_Loop14

s3p22_Loop15:
	dc.b	nBb3, $06, nC4, nD4, nF4
	smpsLoop            $00, $04, s3p22_Loop15
	dc.b	nRst, $60, nRst, $06, nBb4, $12, nA4, $06, nRst, nG4, nRst, nBb4
	dc.b	nRst, nG4, nA4, nRst, nBb4, $12

s3p22_Loop16:
	dc.b	nAb3, $06, nBb3, nC4, nEb4
	smpsLoop            $00, $04, s3p22_Loop16

s3p22_Loop17:
	dc.b	nBb3, $06, nC4, nD4, nF4
	smpsLoop            $00, $04, s3p22_Loop17
	dc.b	nRst, $60, nRst, $06, nBb4, $12, nA4, $06, nRst, nG4, nRst, nBb4
...
s3p22_Loop05:
	...
	dc.b	$06, nBb4, nA4, nRst, nG4, nA4, nG4, nRst, nF4, nG4, nF4, nRst
	dc.b	nE4, nF4, nE4, nRst
	smpsLoop            $00, $02, s3p22_Loop05
	smpsSetvoice        $03

s3p22_Loop06:
	dc.b	nAb3, $06, nBb3, nC4, nEb4
	smpsLoop            $00, $04, s3p22_Loop06

s3p22_Loop07:
	dc.b	nBb3, $06, nC4, nD4, nF4
	smpsLoop            $00, $04, s3p22_Loop07
	dc.b	nRst, $60, nRst, $06, nBb4, $12, nA4, $06, nRst, nG4, nRst, nBb4
	dc.b	nRst, nG4, nA4, nRst, nBb4, $12

s3p22_Loop08:
	dc.b	nAb3, $06, nBb3, nC4, nEb4
	smpsLoop            $00, $04, s3p22_Loop08

s3p22_Loop09:
	dc.b	nBb3, $06, nC4, nD4, nF4
	smpsLoop            $00, $04, s3p22_Loop09
	dc.b	nRst, $60, nRst, $06, nBb4, $12, nA4, $06, nRst, nG4, nRst, nBb4
	dc.b	nG4, nRst, nC5, nRst, nBb4, nRst, nG4
