s3p29_Header:
	...
	smpsHeaderVoice     s3p29_Voices
	smpsHeaderChan      $06, $03
	smpsHeaderTempo     $01, $20

	smpsHeaderDAC       s3p29_DAC
	smpsHeaderFM        s3p29_FM1,	$F4, $0C
	smpsHeaderFM        s3p29_FM2,	$F4, $0E
	smpsHeaderFM        s3p29_FM3,	$00, $15
	smpsHeaderFM        s3p29_FM4,	$00, $20
	smpsHeaderFM        s3p29_FM5,	$00, $0B
	smpsHeaderPSG       s3p29_PSG1,	$E8, $05, $03, $00
	smpsHeaderPSG       s3p29_PSG2,	$E8, $05, $03, $00
	smpsHeaderPSG       s3p29_PSG3,	$00, $00, $00, sTone_03
...
s3p29_Jump01:
	...
	dc.b	$26, nRst, $0A
	smpsJump            s3p29_Jump01

; PSG1 Data
s3p29_PSG1:
	smpsPSGvoice        sTone_09
	dc.b	nRst, $02
	smpsCall            s3p29_Call07

; PSG2 Data
s3p29_PSG2:
	smpsPSGvoice        sTone_09
	dc.b	nRst, $03
	smpsCall            s3p29_Call06
...
s3p29_Loop00:
	smpsCall            s3p29_Call00
	smpsLoop            $00, $04, s3p29_Loop00

s3p29_Loop01:
	smpsCall            s3p29_Call00
	smpsLoop            $00, $07, s3p29_Loop01
	smpsCall            s3p29_Call01

s3p29_Loop02:
	smpsCall            s3p29_Call02
	smpsLoop            $00, $07, s3p29_Loop02
	smpsCall            s3p29_Call03

s3p29_Loop03:
	smpsCall            s3p29_Call02
	smpsLoop            $00, $03, s3p29_Loop03
	smpsCall            s3p29_Call03
	smpsCall            s3p29_Call04

s3p29_Loop04:
	smpsCall            s3p29_Call02
	smpsLoop            $00, $02, s3p29_Loop04
	smpsCall            s3p29_Call05
	smpsJump            s3p29_Loop01
