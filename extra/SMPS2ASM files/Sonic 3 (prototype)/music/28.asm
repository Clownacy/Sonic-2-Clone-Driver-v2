s3p28_Header:
	...
	smpsHeaderVoice     s3p28_Voices
	smpsHeaderChan      $06, $03
	smpsHeaderTempo     $01, $25

	smpsHeaderDAC       s3p28_DAC
	smpsHeaderFM        s3p28_FM1,	$00, $1A
	smpsHeaderFM        s3p28_FM2,	$00, $12
	smpsHeaderFM        s3p28_FM3,	$00, $1A
	smpsHeaderFM        s3p28_FM4,	$00, $1A
	smpsHeaderFM        s3p28_FM5,	$00, $22
	smpsHeaderPSG       s3p28_PSG1,	$0C, $06, $00, sTone_0C
	smpsHeaderPSG       s3p28_PSG2,	$0C, $06, $00, sTone_0C
	smpsHeaderPSG       s3p28_PSG3,	$00, $05, $00, sTone_02
...
s3p28_Jump03:
	...
	smpsCall            s3p28_Call00
	smpsCall            s3p28_Call01
	smpsCall            s3p28_Call02
	dc.b	nE6
	smpsFMAlterVol      $06
	smpsSetvoice        $04
...
s3p28_Loop0A:
	...
	dc.b	nE3, nCs3
	smpsLoop            $00, $02, s3p28_Loop0A

s3p28_Loop0B:
	dc.b	nA3, $12, $06, nRst, $18
	smpsLoop            $00, $02, s3p28_Loop0B
	dc.b	nCs4, $12, $06, nRst, $0C, nA3, $3C
	smpsLoop            $01, $04, s3p28_Loop0B
...
s3p28_Loop06:
	...
	dc.b	nA3, nCs4
	smpsLoop            $00, $02, s3p28_Loop06

s3p28_Loop07:
	dc.b	nFs4, $12, nFs4, $06, nRst, $18
	smpsLoop            $00, $02, s3p28_Loop07
	dc.b	nA4, $12, nA4, $06, nRst, $0C, nE4, $3C
	smpsLoop            $01, $04, s3p28_Loop07
...
s3p28_Loop1B:
	...
	dc.b	nE1, nCs1
	smpsLoop            $00, $02, s3p28_Loop1B
	smpsPSGvoice        sTone_09

s3p28_Loop1C:
	dc.b	nD2, $60, nCs2, nD2, nE2
	smpsLoop            $00, $02, s3p28_Loop1C
...
s3p28_Loop14:
	...
	smpsPSGAlterVol     $04
	dc.b	nMaxPSG2
	smpsLoop            $00, $03, s3p28_Loop14
	dc.b	nMaxPSG2, nMaxPSG2, nMaxPSG2
	smpsPSGvoice        sTone_01
	dc.b	nMaxPSG2
	smpsLoop            $01, $04, s3p28_Loop14
...
s3p28_Loop17:
	...
	smpsPSGAlterVol     $04
	dc.b	nMaxPSG2
	smpsLoop            $00, $03, s3p28_Loop17
	dc.b	nMaxPSG2, $06, nMaxPSG2, nMaxPSG2
	smpsPSGvoice        sTone_01
	dc.b	nMaxPSG2
	smpsPSGvoice        sTone_02
	smpsLoop            $01, $02, s3p28_Loop17
...
s3p28_DAC:
	...
	dc.b	$0C, dKickS3, dKickS3, $06, dSnareS3, $0C, dSnareS3, $06, dSnareS3, dKickS3, $06, dHighTom
	dc.b	$03, dHighTom, dHighTom, $06, dHighTom, dMidTomS3, dMidTomS3, dMidTomS3, dLowTomS3, dLowTomS3, dLowTomS3, dKickS3
	dc.b	dKickS3, dSnareS3, dKickS3, $12

s3p28_Loop00:
	dc.b	dKickS3, $12, dKickS3, $06, dSnareS3, dKickS3, $0C, dKickS3, dKickS3, $12, dSnareS3, $06
	dc.b	dKickS3, $12
	smpsLoop            $00, $03, s3p28_Loop00
