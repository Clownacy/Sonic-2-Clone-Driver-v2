s3p23_Header:
	...
	smpsHeaderVoice     s3p23_Voices
	smpsHeaderChan      $06, $03
	smpsHeaderTempo     $01, $00

	smpsHeaderDAC       s3p23_DAC
	smpsHeaderFM        s3p23_FM1,	$00, $0F
	smpsHeaderFM        s3p23_FM2,	$00, $0C
	smpsHeaderFM        s3p23_FM3,	$00, $0F
	smpsHeaderFM        s3p23_FM4,	$00, $0F
	smpsHeaderFM        s3p23_FM5,	$00, $16
	smpsHeaderPSG       s3p23_PSG1,	$E8, $02, $00, $00
	smpsHeaderPSG       s3p23_PSG2,	$E8, $02, $00, $00
	smpsHeaderPSG       s3p23_PSG3,	$E8, $02, $00, $00
...
s3p23_Loop0E:
	...
	smpsLoop            $00, $02, s3p23_Loop0E
	smpsSetvoice        $03

s3p23_Loop0F:
	dc.b	nAb3, $06, nBb3, nC4, nEb4
	smpsLoop            $00, $04, s3p23_Loop0F

s3p23_Loop10:
	dc.b	nBb3, $06, nC4, nD4, nF4
	smpsLoop            $00, $04, s3p23_Loop10
	dc.b	nRst, $60, nRst, $06, nBb4, $12, nA4, $06, nRst, nG4, nRst, nBb4
	dc.b	nRst, nG4, nA4, nRst, nBb4, $12

s3p23_Loop11:
	dc.b	nAb3, $06, nBb3, nC4, nEb4
	smpsLoop            $00, $04, s3p23_Loop11

s3p23_Loop12:
	dc.b	nBb3, $06, nC4, nD4, nF4
	smpsLoop            $00, $04, s3p23_Loop12
	dc.b	nRst, $60, nRst, $06, nBb4, $12, nA4, $06, nRst, nG4, nRst, nBb4
...
s3p23_Loop0A:
	...
	dc.b	nBb3, $06, nF3, nFs3, nD3, nEb3, nE3, nBb2, nB2, nG2, nAb2, nE2
	dc.b	nFs2
	smpsLoop            $00, $02, s3p23_Loop0A

s3p23_Loop0B:
	dc.b	nRst, $60
	smpsLoop            $00, $08, s3p23_Loop0B
	smpsJump            s3p23_FM3
...
s3p23_Loop00:
	...
	dc.b	$06, nBb4, nA4, nRst, nG4, nA4, nG4, nRst, nF4, nG4, nF4, nRst
	dc.b	nE4, nF4, nE4, nRst
	smpsLoop            $00, $02, s3p23_Loop00
	smpsSetvoice        $03

s3p23_Loop01:
	dc.b	nAb3, $06, nBb3, nC4, nEb4
	smpsLoop            $00, $04, s3p23_Loop01

s3p23_Loop02:
	dc.b	nBb3, $06, nC4, nD4, nF4
	smpsLoop            $00, $04, s3p23_Loop02
	dc.b	nRst, $60, nRst, $06, nBb4, $12, nA4, $06, nRst, nG4, nRst, nBb4
	dc.b	nRst, nG4, nA4, nRst, nBb4, $12

s3p23_Loop03:
	dc.b	nAb3, $06, nBb3, nC4, nEb4
	smpsLoop            $00, $04, s3p23_Loop03

s3p23_Loop04:
	dc.b	nBb3, $06, nC4, nD4, nF4
	smpsLoop            $00, $04, s3p23_Loop04
	dc.b	nRst, $60, nRst, $06, nBb4, $12, nA4, $06, nRst, nG4, nRst, nBb4
	dc.b	nG4, nRst, nC5, nRst, nBb4, nRst, nG4
	smpsJump            s3p23_Jump00

; DAC Data
s3p23_DAC:
	dc.b	dKickS3, $18, dSnareS3, dKickS3, dSnareS3
	smpsLoop            $00, $17, s3p23_DAC
