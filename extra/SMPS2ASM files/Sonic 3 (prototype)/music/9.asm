s3p9_Header:
	...
	smpsHeaderDAC       s3p9_DAC
	smpsHeaderFM        s3p9_FM1,	$00, $10
	smpsHeaderFM        s3p9_FM2,	$00, $0D
	smpsHeaderFM        s3p9_FM3,	$00, $10
	smpsHeaderFM        s3p9_FM4,	$00, $10
	smpsHeaderFM        s3p9_FM5,	$00, $16
	smpsHeaderPSG       s3p9_PSG1,	$E8, $02, $00, $00
	smpsHeaderPSG       s3p9_PSG2,	$E8, $02, $00, $00
	smpsHeaderPSG       s3p9_PSG3,	$E8, $02, $00, $00
...
s3p9_Loop00:
	...
	smpsLoop            $00, $07, s3p9_Loop00
	dc.b	dKickS3, $18, dSnareS3, $0C, dSnareS3

s3p9_Loop01:
	dc.b	dKickS3, $18, dSnareS3
	smpsLoop            $00, $07, s3p9_Loop01
	dc.b	dKickS3, $18, dSnareS3, $0C, dSnareS3

s3p9_Loop02:
	dc.b	dKickS3, $18, dSnareS3
	smpsLoop            $00, $0F, s3p9_Loop02
...
;	Voice $05
;	$38
;	$7B, $5B, $13, $31, 	$16, $15, $14, $12, 	$0E, $01, $05, $04
;	$0C, $13, $0C, $0B, 	$FF, $EF, $DF, $8F, 	$2F, $2F, $1D, $85
	smpsVcAlgorithm     $00
	smpsVcFeedback      $07
	smpsVcUnusedBits    $00
	smpsVcDetune        $03, $01, $05, $07
	smpsVcCoarseFreq    $01, $03, $0B, $0B
	smpsVcRateScale     $00, $00, $00, $00
