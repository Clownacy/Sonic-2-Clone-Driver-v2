...
TubePanic_Loop06:
	...
	smpsCall            TubePanic_Call08
	smpsChangeTransposition $FE
	smpsLoop            $00, $02, TubePanic_Loop06
	smpsFMAlterVol      $FE
...
TubePanic_Loop05:
	...
	smpsCall            TubePanic_Call05
	smpsChangeTransposition $FE
	smpsLoop            $00, $02, TubePanic_Loop05
...
TubePanic_Loop0C:
	...
	smpsCall            TubePanic_Call12
	smpsChangeTransposition $FE
	smpsLoop            $00, $02, TubePanic_Loop0C

TubePanic_Loop0D:
	smpsCall            TubePanic_Call13
	smpsLoop            $00, $03, TubePanic_Loop0D
...
TubePanic_Loop0A:
	...
	smpsCall            TubePanic_Call12
	smpsChangeTransposition $FE
	smpsLoop            $00, $02, TubePanic_Loop0A

TubePanic_Loop0B:
	smpsCall            TubePanic_Call13
	smpsLoop            $00, $03, TubePanic_Loop0B
	dc.b	nA4, $06, nAb4, nE4, nB3, nRst, $0C, nA4, $06, nAb4, nE4, nB3
	dc.b	nRst, $0C, nA4, $06, nAb4, nE4, nB3, nRst, $0C, nEb4, $06, nD4
	dc.b	nBb3, nF3, nRst, $0C, nF4, $06, nE4, nC4, nG3, nF3, nE3, nC3
	dc.b	nG2
	smpsJump            TubePanic_Loop0A
...
TubePanic_Loop09:
	...
	smpsLoop            $01, $18, TubePanic_Loop09
