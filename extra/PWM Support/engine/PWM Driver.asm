...
PWM_Driver:
	...
	binclude	"Clone Driver v2/engine/Chaotix PWM Driver.bin",0,$1F0	; Include first half of driver
	dc.l	$22000000|SH2_PWMTable
	binclude	"Clone Driver v2/engine/Chaotix PWM Driver.bin",$1F4,$20C	; Include second half of driver
PWM_Driver_End
...
; ---------------------------------------------------------------
	...
	include "Clone Driver v2/Sonic 2 Clone Driver v2 - PWM Samples.asm"
